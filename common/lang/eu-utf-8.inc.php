...
define("MENU_Inicio","Hasiera");

define("MENU_MiCuenta","Nire kontaketa");
define("MENU_Usuarios","Erabiltzaileak");
define("MENU_NuevoUsuario","Erabiltzaile berria");
define("MENU_DatosTesauro","LexikoarenDatuak");

define("MENU_AgregarT","Terminoa eranstea");
define("MENU_EditT","Terminoa editatzea");
define("MENU_BorrarT","Terminoa eliminatzea");
...
define("LABEL_Admin","Administrazioa");
define("LABEL_Agregar","Eranstea");
define("LABEL_editT","Terminoa aldatzea ");
...
define("LABEL_Idioma","Hizkuntza");
define("LABEL_Fecha","SorkuntzarenEgunean");
define("LABEL_Keywords","Gako-hitzak");
define("LABEL_TipoLenguaje","HizkuntzarenTipoa");
...
define("FORM_LABEL_apellido","_Deitura");
define("FORM_LABEL_mail","_Electronico posta");
define("FORM_LABEL_pass","_Klabea");
define("FORM_LABEL_repass","_Klabea_baieztatzea");
define("FORM_LABEL_orga","Organizazioa");

define("LABEL_nombre","Izena");
define("LABEL_apellido","Deitura");
define("LABEL_mail","Electronico posta");
define("LABEL_pass","Klabea");
define("LABEL_repass","Klabea baieztatzea");
define("LABEL_orga","Organizazioa");

define("LABEL_lcConfig","Konfigurazioa");
define("LABEL_lcDatos","LexikoarenDatuak");

define("LABEL_Titulo","Izenburua");

define("FORM_LABEL_Titulo","_Izenburua");
define("FORM_LABEL_Autor","_Egilea");
define("FORM_LABEL_URI","_URI");
define("FORM_LABEL_Idioma","Hizkuntza");
define("FORM_LABEL_FechaDia","Egunean");
define("FORM_LABEL_FechaMes","Hilarengan");
define("FORM_LABEL_FechaAno","Urtean");
define("FORM_LABEL_Keywords","Gako-hitza");
define("FORM_LABEL_TipoLenguaje","HizkuntzarenTipoa");
define("FORM_LABEL_Cobertura","Eremua");
define("FORM_LABEL_Terminos","Terminoak");
define("FORM_LABEL_RelTerminos","Terminoen arteanZerikusiak");
define("FORM_LABEL_TerminosUP","Terminoen arteanZerikusiak");
define("FORM_LABEL_Guardar","Gordetzea");

define("LABEL_verDetalle","Detaileak ikustea ");
...
/* v 9.2 */
define("LABEL_negrita","Beltz-txoa");
define("LABEL_italica","itálica");
define("LABEL_subrayado","Azpimarratuta");
define("LABEL_textarea","NotentzatEspazioa");
define("MSGL_relacionIlegal","Ez terminoen artean utzia zerikusia");

/* v 9.3 */
define("LABEL_fecha_modificacion","Aldaketa");
define("LABEL_TotalUsuarios","ErabiltzaileenErabatekoa");
define("LABEL_TotalTerminos","TerminoenErabatekoa");
define("LABEL_ordenar","Ordenatzea");
define("LABEL_auditoria","TerminoenKontu-ikuskaritza");
define("LABEL_dia","Egunean");
define("LABEL_mes","Hilarengan");
define("LABEL_ano","Urtean");
define("LABEL_terminosRepetidos","Repetido terminoak");
...
/* v 9.6 */
define("LABEL_relacion_vocabulario","Beste lexiko batekinZerikusia");
define("FORM_LABEL_relacion_vocabulario","Baliokidetasuna");
define("FORM_LABEL_nombre_vocabulario","KontaketarenLexikoa");
define("LABEL_vocabulario_referencia","KontaketarenLexikoa");
define("LABEL_NO_vocabulario_referencia","Kontaketaren lexikoak ez aurkitu establer-tzeko zerikusi terminologikoa");
define("FORM_LABEL_tipo_equivalencia","BaliokidetasunarenTipoa");
define("LABEL_vocabulario_principal","Lexikoa");
define("LABEL_tipo_vocabulario","Tipoa");
...
define("LABEL_Ultimos_aceptados","Egin berriak onartuak");
define("MSG_ERROR_ESTADO","Ez onargarria Estatua");

define("LABEL_Candidatos","Hautagai terminoak");
define("LABEL_Aceptados","Termino onartuak");
...
/* v 1.01 */
define("LABEL_TERMINO_SUGERIDO","Beharbada esan nahi izan zuen:");
