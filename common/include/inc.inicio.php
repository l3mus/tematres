...
if((strlen($letra)>0) && (strlen($letra)<5))//ne
{
	//echo 'test injection';
...
elseif (strlen($search_string)>0) {//ne
...
elseif(//тука е стартовия вариант на страницата
...
{
	//echo 'test injection';
	require_once(T3_ABSPATH . 'common/include/inc.vistaTermino.php');//това дава съдържанието на <div id="wrap" class="container">
}
